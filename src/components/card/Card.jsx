...
const data = [
  {
    ...
    description: `Enter your National Identity Card number and date of birth (according to the National Identity Card) in the form below and click on the "Verify" button. An OTP code will be sent via SMS to the mobile number provided at the time of registration. Then, you can download the Covid-19 Vaccine Card.`,
  },
  {
    head: "Birth Reg. Certificate",
    description: `Enter your Birth Certificate number and date of birth (according to the Birth Certificate) in the form below and click on the "Verify" button. An OTP code will be sent via SMS to the mobile number provided at the time of registration. Then, you can download the Covid-19 Vaccine Card.`,
  },
  {
    head: "Passport",
    description: `Enter your Passport number and date of birth (according to the Passport) in the form below and click on the "Verify" button. An OTP code will be sent via SMS to the mobile number provided at the time of registration. Then, you can download the Covid-19 Vaccine Card.`,
  },
];
